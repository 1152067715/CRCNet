...
CONFIG={
    ...
    "dataset":{
        "name":"Kvasir-SEG",                                      # "Kvasir-SEG", "CVC-ClinicDB",
        "random_state":2021,
    ...
    "train":{
        ...
        "batch_size":8,                                         # 14 (224x224) ; 8 (256x256) for "Kvasir-SEG", "CVC-ClinicDB" with 16G GPU
    ...
    "val":{
        "image_size":(320,320),                  #h w  (320x320) for "Kvasir-SEG", (288x384) for "CVC-ClinicDB" with 16G GPU
        "batch_size":1,
